          ...
          <View style={{ height: props.height, width: props.width }}>
            ...
            >
              <View style={styles.imageContainer}>
                ...
                >
                  {props.number ? creditcardutils.formatCardNumber(String(props.number)):"**** **** **** ****"}
                </Text>
                  ...
                  <View style={styles.groupContainer}>
                    {/* {props.expiration && (
                      <>
                        ...
                        >
                          { props.expiration ? creditcardutils.formatCardExpiry(props.expiration): "****"}
                        </Text> 
                        <Text
                          style={{
                            fontSize: props.fontSize * 0.7,
                        ...
                        >
                          {props.expiration ? props.expiration : "** / **"}
                        </Text> 
                      </>
                    )} */}
